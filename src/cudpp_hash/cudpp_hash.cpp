...
typedef CUDPPHashTableInternal<CudaHT::CuckooHashing::CompactingHashTable>
    hti_compacting;
typedef CUDPPHashTableInternal<CudaHT::CuckooHashing::MultivalueHashTable>
    hti_multivalue;
 ...
 */
CUDPP_DLL
CUDPPResult cudppHashTable(CUDPPHandle cudppHandle, CUDPPHandle *plan,
 ...
 */
CUDPP_DLL
CUDPPResult cudppDestroyHashTable(CUDPPHandle cudppHandle, CUDPPHandle plan) {
 ...
 */
CUDPP_DLL
CUDPPResult cudppMultivalueHashGetValuesSize(CUDPPHandle plan,
                                             unsigned int *size) {
  hti_void *hti_init = (hti_void *)getPlanPtrFromHandle<hti_void>(plan);
 ...
 */
CUDPP_DLL
CUDPPResult cudppMultivalueHashGetAllValues(CUDPPHandle plan,
                                            unsigned int **d_vals) {
  hti_void *hti_init = (hti_void *)getPlanPtrFromHandle<hti_void>(plan);
  if (hti_init->config.type != CUDPP_MULTIVALUE_HASH_TABLE) {
    // better be a MULTIVALUE
